      ...
      <Card className="w-full max-w-md shadow-lg border">
        ...
        <CardContent className="space-y-6">
          ...
          <div>
            ...
            <RadioGroup defaultValue="bank" onValueChange={setPaymentMethod} className="flex space-x-4 mt-2">
        ...
        <CardFooter>
          <Button className="w-full py-3" size="lg" disabled={!isValid || uploading} onClick={handleSubmit}>
            {uploading
              ? "Submitting..."
              : amount === 0
